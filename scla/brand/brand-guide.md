...
Canonical org identity: `context/me.md`.

This positioning — academic recognition paired with practical career tools at
scale (100,000+ members, 850+ campuses) — is the confirmed framing. Sections
marked `TODO: needs input` await brand assets (logo SVGs, brand guidelines PDF).
...
- **"Honor Society" capitalization — capitalize both words.** All
