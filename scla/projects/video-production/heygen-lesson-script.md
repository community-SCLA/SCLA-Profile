...
Turn any SCLA lesson's course material into a produce-ready video script in SCLA's house style. Derived from the Early Career Boost track — see [`early-career-boost-video-style.md`](early-career-boost-video-style.md) for the rationale and examples.
...
- **Key teaching points:** <3–6 bullets from the lesson>
...
> Narration for the HeyGen avatar. Follow the arc below. Second person. Open with a hook, not a definition. Short punchy sentences mixed with longer ones. Use rhetorical questions to transition. End by pointing to the activity.
...
`[Graphic: <bias cards / labels appearing one at a time, if applicable>]`
...
- [ ] Voice is Ann the coach — second person, warm, direct.
- [ ] Opens with a hook/myth-bust, not a definition.
