...
*source: Apr 6 notes (archived externally — not in repo) — Iman Lomax*
...
*source: Apr 6 notes (archived externally — not in repo) — Iman Lomax and Zeketra Grandy*
...
| Field | Value |
|---|---|
| Organization | The Society for Collegiate Leadership & Achievement (SCLA) |
| Category | College-to-Career Honor Society |
