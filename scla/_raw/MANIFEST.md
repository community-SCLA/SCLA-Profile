...
|---|---|---|---|
| 2026-04-23 | https://www.thescla.org/ (search-index snapshot; direct fetch returned HTTP 403) | scla/_raw/web/www.thescla.org/index.md | 7186 |
...
| Errors logged | 3 | See scla/_raw/INGEST_ERRORS.md |

### Files written this run

| File | Description | Bytes |
|---|---|---|
| scla/_raw/web/www.thescla.org/index.md | Search-index snapshot of root URL + known sub-pages + partial content | 7186 |
| scla/_raw/INGEST_ERRORS.md | Error log with remediation instructions | 4208 |
| scla/_raw/MANIFEST.md | This file | — |
