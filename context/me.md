...
- **Alyssa** — Onboarding (paired with Zeketra)
- **Iman Lomax** — Info sessions and member advocacy
- **Jenna** — Info session materials
- **Anushka** — Focus Modes content build
- **Sean/Shawn** *(spelling TBD)* — Tech team primary contact
- **Chuck** *(full name TBD)* — Leadership contact for community team
