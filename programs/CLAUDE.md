# programs/ — Scoped Context

Program reference pages at this level; program-specific working docs in one subfolder per program (see `README.md` for the current list).

Rules for work in this folder:

- **Program names:** `programs-overview.md` is the canonical directory — check it before writing and use names exactly as listed.
