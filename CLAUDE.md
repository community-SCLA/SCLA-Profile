...
**Session boot:** load `context/me.md`, identify the task, load ONE target from the table.
...
| Check goals or current priorities | `context/goals.md`, `context/current-priorities.md` |
...
| Work with a partner org | `partnerships/` |
...
| Write a HeyGen lesson video script | `templates/heygen-lesson-script.md` |
...
No matching row? Every multi-file folder carries a README.md hub listing its contents — load that, not the whole folder. (The programs hub is `programs/programs-overview.md`.)
