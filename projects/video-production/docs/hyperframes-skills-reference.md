...
| 3 · Support | **hyperframes-creative** | Non-animation creative direction: design specs (design.md), palettes, typography, narration, beat planning, brand/style calls. | Deciding look-and-feel, narration, or creative direction. | Motion mechanics (→ hyperframes-animation). |
