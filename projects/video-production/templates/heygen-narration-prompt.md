...
```
Write the spoken narration for an SCLA lesson video. This text goes directly to
an AI avatar (HeyGen) that will read it aloud word-for-word, so output ONLY the
words to be spoken.

Lesson: [LESSON NUMBER] — [LESSON TITLE]
Audience: SCLA college-student members, ages 18–24, preparing for [TOPIC / CAREER AREA].
Target length: 5–7 minutes (~450–650 words).

Presenter voice: Ann, a warm, encouraging career coach speaking directly to one
early-career learner. Second person ("you"). Warm, professional, encouraging.
Active voice. Short punchy sentences mixed with longer ones. No jargon, no
corporate speak.
...
2. Confirm the voice is Ann the coach: second person, warm, direct, no jargon.
3. Check length: word count ÷ ~130 = approximate minutes (aim for 5–7).
...
- Tone: warm, professional, encouraging; second person; no jargon or passive voice.
