...
- **33** — **live on Wistia.** Done; links in the *Delivered* table below.
...
- **6** — **waiting on your eyes.** The mechanical and visual receipts match this source; no MP4 yet, and each lesson can be reviewed independently.
