...
for source, relative in [
    ...
    (RQ / "src" / "gate_contract.py",
     "projects/video-production/render-qa/src/gate_contract.py"),
    (RQ / "src" / "run_state.py",
     "projects/video-production/render-qa/src/run_state.py"),
    (RQ / "src" / "visual_review_receipt.py",
     "projects/video-production/render-qa/src/visual_review_receipt.py"),
    (RQ / "src" / "hfp_common.py",
     "projects/video-production/render-qa/src/hfp_common.py"),
    (RQ / "src" / "stem.py",
