...
Use only the approved SCLA navy, deep navy, blue, gold, white, and muted blue tokens. Proxima Nova loads from frozen local font files and GSAP loads from the approved local runtime. The workbench frame and compact current-phase label persist across all 49 beats, while each phase uses a materially different spatial interaction. Gold identifies the active claim or decision; blue identifies structure and evidence. All changes live on one paused, seek-safe timeline with deterministic arbitrary seeking. The phase label and slow field pulse provide continuity without substituting for the workbench transformations.
