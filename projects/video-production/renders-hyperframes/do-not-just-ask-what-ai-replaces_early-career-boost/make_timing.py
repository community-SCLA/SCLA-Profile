...
Never hand-tune a number here. Every value is derived from audio_meta.json
(what the engine actually returned) plus four declared constants, so re-running
after a re-synthesis reproduces the timeline exactly.
