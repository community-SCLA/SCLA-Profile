...
# GAP - PRE is the air every beat gets after its last word before its picture
# cuts: 0.40s, above check_boundaries' MIN_AIR (0.2) and MIN_QUESTION_AIR
# (0.35) floors before the clip's own trailing silence is counted at all.
