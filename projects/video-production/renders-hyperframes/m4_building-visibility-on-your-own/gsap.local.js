(function(global){
  class Timeline {
    constructor(options={}) { this._paused=options.paused!==false; this._time=0; this._duration=0; this._timeScale=1; this._tweens=[]; }
    ...
    totalTime(value) { return value===undefined?this._time:this.seek(value); }
    duration() { return this._duration; }
    totalDuration() { return this._duration; }
    getChildren() { return []; }
    timeScale(value) { if(value===undefined)return this._timeScale; this._timeScale=Number(value)||1; return this; }
