...
| `what-energizes-me_..._2026-07-10.txt` | 2026-07-10 | 2026-07-14 | 2026-07-15 → `../renders-mp4/early-career-boost/what-energizes-me_early-career-boost_2026-07-15.mp4` · Wistia https://sclc.wistia.com/medias/of5caanz21 | in `rendered/`; **published 2026-07-15** to Wistia "Early Career Boost" project (id 10733647), hashedId `of5caanz21`, 163.6s. Theme summit, 18 scenes, verify PASS + frame self-review PASS. Owner directed publish this session and waived the MP4-review gate on the record. Refine notes: 647→447 words; source thin on narration, faithful over padded. qa-facts **PASS**. NOTE: opening "the five conditions" traces cross-lesson to `what-makes-for-a-dream-job` / "Five Criteria of Engaging Work" (not stated in this lesson's own raw) — defensible, no change; revisit if the criteria lesson is recut to a different count |
