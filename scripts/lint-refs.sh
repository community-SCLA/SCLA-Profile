...
echo "[12/12] community-email test suite"
if TEST_OUT="$(bash projects/community-email/run.sh test 2>&1)"; then
  ok "community-email tests passed"
else
  warn "community-email suite FAILED:\n$TEST_OUT"
fi
